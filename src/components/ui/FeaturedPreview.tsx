      ...
      try {
        ...
        const allItems: FeaturedPreviewItem[] = [
          ...(data.events || []).map((e) => ({
            ...
            category: "Event",
            image: e.coverImage
              ? sanityImageUrl(e.coverImage, 400)
              : e.gallery?.[0]
                ? sanityImageUrl(e.gallery[0], 400)
          ...
          ...(data.posts || []).map((p) => ({
            ...
            image: p.coverImage ? sanityImageUrl(p.coverImage, 400) : "/images/community/community-1.jpg",
          })),
        ];
    ...
    >
      <div className="relative w-80 overflow-hidden rounded-2xl bg-masaf-cream/95 backdrop-blur-sm shadow-2xl border border-white/20">
        <Link href={href} className="block group">
          <div className="relative h-44 overflow-hidden bg-masaf-tan/20">
            {items.map((item, index) => (
              ...
              >
                ...
                <Image
                  ...
                  sizes="320px"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-masaf-ink/60 via-transparent to-transparent pointer-events-none" />
              </div>
            ))}
